...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">@lang('roles/title.roles')</li>
    </ol>
</section>
                                    ...
                                    <td>
                                        <a href="{{ route('update/role', $role->id) }}">
                                            ...
                                            @if ($role->id !== 1)
                                                ...
                                                @else
                                                    <a href="{{ route('confirm-delete/role', $role->id) }}" data-toggle="modal" data-target="#delete_confirm">
